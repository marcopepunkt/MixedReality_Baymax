...
class GeminiGUI:
    DEFAULT_IMAGE_PROMPT = "Describe this photo to a blind person to help them understand where they are and for navigation purposes."
    ...
    def setup_image_tab(self):
        # Information frame at the top
        info_frame = ttk.Frame(self.image_tab)
        info_frame.pack(fill='x', padx=5, pady=5)
        
        info_label = ttk.Label(info_frame, 
                             text="Default Prompt: Analyze images to help visually impaired users understand their surroundings",
        ...
        # Content frame for preview and analysis
        ...
        # Prompt frame with default text
        prompt_frame = ttk.LabelFrame(analysis_frame, text="Prompt (Default provided)")
        ...
        self.image_prompt.insert("1.0", self.DEFAULT_IMAGE_PROMPT)
        
        # Button frame
        button_frame = ttk.Frame(analysis_frame)
        button_frame.pack(fill='x', pady=5)
        
        analyze_btn = ttk.Button(button_frame, text="Analyze Image", 
                               command=self.analyze_image)
        analyze_btn.pack(side='left', padx=5)
        
        reset_prompt_btn = ttk.Button(button_frame, text="Reset to Default Prompt", 
                                    command=self.reset_prompt)
        reset_prompt_btn.pack(side='left', padx=5)
    ...
    def reset_prompt(self):
        """Reset the prompt text to default"""
